"""NVIDIA NIM chat request tuning (provider-owned; mapped from :class:`config.nim.NimSettings`)."""

from pydantic import BaseModel, ConfigDict, Field, ValidationInfo, field_validator


class NimRequestOptions(BaseModel):
    """OpenAI/NIM request parameters for the NVIDIA NIM adapter."""
